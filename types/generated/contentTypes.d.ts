...
export interface ApiLandingPageLandingPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    benefitSection: Attribute.Component<'landing-page.benefit-section'>;
    langkahSection: Attribute.Component<'landing-page.langkah-section'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiNavbarNavbar extends Schema.SingleType {
  ...
  attributes: {
    ...
    forCompanyBtn: Attribute.String & Attribute.Required;
